  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        <code>support@fyralabs.com</code>!
      </p>
      ...
      <p>
        ...
        <code>support@fyralabs.com</code> with photos of wrong/damaged items and
      ...
      <p>
        ...
        <code>support@fyralabs.com</code> within a week after receiving your
        order. Include your order number and photos of the mislabeled item, and
